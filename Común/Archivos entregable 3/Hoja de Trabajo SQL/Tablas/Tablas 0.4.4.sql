------------------------------------VERSIÓN 0.4.4------------------------------------   
  --Este script contiene las tablas y drop tables pertenecientes a los subsistemas de producción, almacén y técnico.
  --Respecto a la versión anterior:
  --Corrección de foreign keys de las tablas de mantenimiento y envíos
  --Adición de constraints para fechas
  --Asignación de claves candidatas para algunas tablas
  --Corrección del orden de creación y borrado de las tablas
  --Adicion de inserts
------------------------------------DROP_TABLES------------------------------------   
...
insert into TRANSPORTE values(1,'Furgoneta',2,'Avenida Merico,Nº3');
...
insert into MANTENIMIENTO values(TO_DATE('2019/05/03 19:00:00','yyyy/mm/dd hh24:mi:ss'),TO_DATE('2019/05/04 00:00:00','yyyy/mm/dd hh24:mi:ss'),1,1);